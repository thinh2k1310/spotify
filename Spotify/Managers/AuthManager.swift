...
import Foundation
struct Constants {
    static let clientId = "c73460fa53f2458ebd5bea77a943d802"
    static let clientSecret = "f2c15b06a6444213981f91164b2d5f7b"
    static let  tokenAPIURL = "https://accounts.spotify.com/api/token"
    static let redirectURI = "https://www.facebook.com/quocthinh1310/"
...
final class AuthManager {
    ...
    public var signInURL : URL? {
        ...
        let baseURL = "https://accounts.spotify.com/authorize?response_type=code"
        let url = "\(baseURL)&client_id=\(Constants.clientId)&scope=\(Constants.scope)&redirect_uri=\(Constants.redirectURI)&show_dialog=TRUE"
    ...
    private var tokenExpirationDate: Date?{
        return UserDefaults.standard.object(forKey: "expirationDay") as? Date
    }
